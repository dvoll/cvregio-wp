                ...
                <div className="cv-intro-box__content">
                    <div className="cv-intro-box__col cv-intro-box__col1">
                        <InfoRow
                            ...
                            title={location}
                            edit={edit}
                            onChange={handleValueChange && (value => handleValueChange('location', value))}
                            // TODO: change icon
                        />
                        <InfoRow
                            label="Teilnehmer"
                            title={target}
                            edit={edit}
                            onChange={handleValueChange && (value => handleValueChange('target', value))}
                            // TODO: change icon
                        />
                        <InfoRow
                            label="Zeit"
                            title={time}
                            edit={edit}
                            onChange={handleValueChange && (value => handleValueChange('time', value))}
                            // TODO: change icon
                        />
                    </div>
