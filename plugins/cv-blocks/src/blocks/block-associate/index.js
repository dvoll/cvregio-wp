...
// Register the block
registerBlockType('cv-blocks/cv-associate', {
    title: 'Mitarbeiter-Item',
    description: 'Ein Element mit Profilbild, Name und Rolle eines Mitarbeiters.',
    icon: 'align-left',
    category: 'common',
    keywords: ['Mitarbeiter', 'Profil'],
