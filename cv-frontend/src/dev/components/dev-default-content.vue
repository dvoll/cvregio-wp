<template>
    <article id="post-225" class="post-225 page type-page status-publish hentry entry">
        ...
        <div class="entry-content">
                ...
                <div class="wp-block-coblocks-pricing-table__inner">
                    <div class="wp-block-coblocks-pricing-table-item">
                        <div class="wp-block-coblocks-pricing-table-item__price-wrapper">
                            <span class="wp-block-coblocks-pricing-table-item__amount">77</span>
                        </div>
            ...
            <div class="wp-block-atomic-blocks-ab-pricing ab-pricing-columns-2">
                <div class="ab-pricing-table-wrap ab-block-pricing-table-gap-2">
                    <div
