...
wp_enqueue_script('cv-frontend-chunk-common', content_url() . '/themes/cv-regio-theme/cv-frontend/chunk-common.ba4d3af0.js', array(), '1.0', true );

wp_enqueue_script('cv-frontend-app', content_url() . '/themes/cv-regio-theme/cv-frontend/app.84656d11.js', array(), '1.0', true );
...
wp_register_style(
    ...
    content_url() . '/themes/cv-regio-theme/cv-frontend/chunk-common.f16b10cb.css',
    array( 'wp-editor' )
);
