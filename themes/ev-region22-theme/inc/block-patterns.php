...
/**
 * Ev. Region 22 Block Theme: Block Patterns
 *
 ...
 * @return void
 */
function evregion22theme_register_block_patterns()
{
	$block_pattern_categories = array(
		'featured' => array('label' => __('Featured', 'evregion22theme')),
		'footer'   => array('label' => __('Footers', 'evregion22theme')),
		'header'   => array('label' => __('Headers', 'evregion22theme')),
		'query'    => array('label' => __('Query', 'evregion22theme')),
		'pages'    => array('label' => __('Pages', 'evregion22theme')),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters('evregion22theme_block_pattern_categories', $block_pattern_categories);
	 ...
	 */
	$block_patterns = apply_filters('evregion22theme_block_patterns', $block_patterns);

	foreach ($block_patterns as $block_pattern) {
		$pattern_file = get_theme_file_path('/inc/patterns/' . $block_pattern . '.php');

		register_block_pattern(
			'evregion22theme/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action('init', 'evregion22theme_register_block_patterns', 9);
